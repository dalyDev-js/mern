...
//                 <div className="text-black text-3xl font-bold p-5 font">
//                   Handsly
//                 </div>
//                 <p className="text-justify text-black">
//                   A freelance platform for engineers connects skilled
//                   professionals with businesses and clients seeking engineering
//                   expertise. These platforms allow engineers to find
//                   project-based work, offering flexibility in terms of location
//                   and schedule.
//                 </p>
//               </div>
...
//                 <div>
//                   <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 text-black">
//                     Company
//                   </h2>
//                 </div>
...
//           </div>
//         </div>
//         <div className="bg-amber-300 py-4 text-gray-100">
//           <div className="container mx-auto px-4">
//             <div className="-mx-4 flex flex-wrap justify-between">
//               <div className="px-4 w-full text-center sm:w-auto sm:text-left"></div>
//               <div className="px-4 w-full text-center sm:w-auto sm:text-left"></div>
//             </div>
//           </div>
//         </div>
