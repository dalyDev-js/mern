  ...
  return (
    <>
      ...
      <div className="job-posting-job pt-16 ">
        <div className="client w-full lg:w-5/6 mx-auto ">
          {isFormVisible && (
            <div className="posting-form fixed inset-0 flex justify-center items-center bg-black bg-opacity-35">
              <div className="form w-full md:w-4/5 lg:w-3/5 mx-auto h-5/6 p-7 bg-white rounded-lg">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="job-title-budget flex flex-col md:flex-row gap-2 mt-3">
                    <div className="job-title w-full md:w-2/3">
                    ...
                    <div className="job-budget w-full md:w-1/3">
                  ...
                  <div className="skill-input-container">
                    <div className="w-full flex flex-col md:flex-row items-center mb-4 mt-8">
                      <div className="w-full md:w-3/4">
                        <input
                          placeholder="Add new skill"
                          value={inputValue}
                          onChange={(e) => setInputValue(e.target.value)}
                          className="w-full rounded-md border p-2 outline-none border-gray-700 focus:ring-amber-400 focus:border-amber-400"
                        />
                      </div>
                      <button
                        type="button"
                        className="ml-0 md:ml-3 mt-3 md:mt-0 bg-amber-300 text-black px-4 py-2 rounded-md"
                    ...
                    <div className="tags-list flex flex-wrap">
                      {tags.map((tag, index) => (
                        <span
                          key={tag.id}
          ...
          <div className="hiring-required flex flex-col lg:flex-row w-full mb-11">
            <div className="steps block w-full lg:w-2/3">
              <p className="text-4xl font-semibold">Dashboard</p>
              <p className="text-3xl mt-3">
                Complete these steps to stand out and hire fast
              </p>
              <div className="required flex flex-col lg:flex-row gap-3 mt-5 mb-6">
                <div className="billing shadow-xl w-full lg:w-1/2 p-4 rounded-xl bg-white">
                  ...
                  <div className="add-billing flex mt-3">
                    ...
                    <div className="billing-logo flex items-center justify-center w-1/4">
                      <i className="text-4xl fa-solid fa-dollar-sign"></i>
                    </div>
                  </div>
                </div>
                <div className="verify shadow-xl w-full lg:w-1/2 p-4 rounded-xl bg-white">
                  <p className="ms-7 text-sm text-gray-500">Required to hire</p>
                  <div className="add-billing flex mt-3">
                    <div className="billing-data flex gap-2 items-center w-3/4">
            ...
            <div className="post-job w-full lg:w-1/3 flex justify-end">
              <button
          ...
          <div className="post-tips grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
            <div className="post-job-1 h-80 flex flex-col justify-between py-4 border-2 border-dashed border-gray-300 rounded-xl">
            ...
            <Link
              to={"/recent-posts"}
              className="post-job-2 h-80 flex flex-col justify-between py-4 border-2 border-gray-300 rounded-xl hover:cursor-pointer hover:scale-95 transition duration-75">
              <div className="first-top mx-7 flex flex-col">
                <div className="flex w-full justify-start">
                  <span>
                    <i className="fa-regular fa-lightbulb me-2 text-lg font-medium"></i>
                  </span>
            ...
            <div className="post-job-2 h-80 flex flex-col justify-between py-4 border-2 border-gray-300 rounded-xl hover:cursor-pointer hover:scale-95 transition duration-75">
              <div className="first-top mx-7 flex flex-col">
                <div className="flex w-full justify-start">
                  <span>
                    <i className="fa-regular fa-lightbulb me-2 text-lg font-medium"></i>
            ...
            <div className="post-job-1 h-80 flex flex-col justify-between py-4 border-2 border-dashed border-gray-300 rounded-xl hover:cursor-pointer hover:scale-95 transition duration-75">
              <div className="first-top mx-7 text-center flex flex-col items-center">
                <i className="text-4xl fa-regular fa-comments"></i>
                <p className="mt-3 text-gray-500 font-semibold">
          ...
          <div className="post-tips-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
            <div className="post-job-1-3 h-80 flex flex-col justify-between py-4 bg-amber-300 rounded-xl">
            ...
            <div className="post-job-1 h-80 flex flex-col justify-center items-center py-4 border-2 border-gray-300 rounded-xl">
          ...
          <div className="get-start flex flex-col md:flex-row p-6 w-full h-auto md:h-48 bg-white shadow-xl rounded-xl">
            <div className="text-data w-full md:w-2/3">
            ...
            <div className="icons w-full md:w-1/3 flex justify-center md:justify-end">
              <img src={start} className="w-1/3" alt="Get Started" />
            </div>
          </div>

          <div className="info grid grid-cols-1 md:grid-cols-3 gap-4 w-full my-6">
            <div className="payment-1 flex p-6 rounded-xl shadow-xl bg-white h-full">
